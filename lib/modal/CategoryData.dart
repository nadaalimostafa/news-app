...
class CategoryData {
  ...
  static List<CategoryData> categoryModal =  [
    ...
    CategoryData(color: const Color(0xff003E90), title: "Politics ", id: "politics", imageName: "Politics.png"),
    ...
    CategoryData(color: const Color(0xff4882CF), title: "Environment ", id: "environment", imageName: "environment.png"),
